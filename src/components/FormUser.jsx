...
import '../styles/@media/formUser.css'
...
function FormUser() {
    ...
    const form = useRef();
    const [buttonText, setButtonText] = useState('Онлайн запись');
    ...
    return(
        <div className='form' id='form'>
            <Modal show={show} className='form-modal'>
                <Modal.Header className='form-modal__title'>Политика в отношении обработки персональных данных</Modal.Header>
                <Modal.Body className='form-modal__text'>1. Общие положения
                    Настоящая политика обработки персональных данных составлена в соответствии с требованиями Федерального закона от 27.07.2006. № 152-ФЗ «О персональных данных» (далее — Закон о персональных данных) и определяет порядок обработки персональных данных и меры по обеспечению безопасности персональных данных, предпринимаемые ИП Голубевым Юрием Юрьевичем (далее — Оператор).<br/>
                    1.1. Оператор ставит своей важнейшей целью и условием осуществления своей деятельности соблюдение прав и свобод человека и гражданина при обработке его персональных данных, в том числе защиты прав на неприкосновенность частной жизни, личную и семейную тайну.<br/>
                    1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее — Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта <Link href='http://izhton.ru'>http://izhton.ru</Link>.<br/>
                    ...
                    2.3. Веб-сайт — совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу <Link href='http://izhton.ru'>http://izhton.ru</Link>.<br/>
                    ...
                    2.8. Персональные данные — любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта http://izhton.ru.<br/>
                    ...
                    2.10. Пользователь — любой посетитель веб-сайта <Link href='http://izhton.ru'>http://izhton.ru</Link>.<br/>
                    ...
                    8.3. В случае выявления неточностей в персональных данных, Пользователь может актуализировать их самостоятельно, путем направления Оператору уведомление на адрес электронной почты Оператора <a href='mailto:izhton68@gmail.com'>izhton68@gmail.com</a> с пометкой «Актуализация персональных данных».<br/>
                    ...
                    Пользователь может в любой момент отозвать свое согласие на обработку персональных данных, направив Оператору уведомление посредством электронной почты на электронный адрес Оператора <a href='mailto:izhton68@gmail.com'>izhton68@gmail.com</a> с пометкой «Отзыв согласия на обработку персональных данных».<br/>
                    ...
                    12.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты <a href='mailto:izhton68@gmail.com'>izhton68@gmail.com</a>.<br/>
                    ...
                    12.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу <Link href='http://izhton.ru'>http://izhton.ru</Link>.
                </Modal.Body>
                <Modal.Footer className='form-modal__btn'>
                    <Button variant='secondary' onClick={handleClose} className='form-modal__btn-content'><span className='text'>Понятно</span></Button>
                </Modal.Footer>
            </Modal>
            <Form className='form-container' ref={form} onSubmit={sendEmail}>
                <div className='container'>
                    <div className='form-container__content'>
                        ...
                        <p>Заполните поля формы, чтобы мы могли<br/>связаться с вами и записать на свободное время</p>
                    </div>
                    <div style={{}} className='container_content'>
                    ...
                    <Button variant="warning" type="submit" className='form-container__btn'>
                        <span className='btn'> {buttonText} </span>
                    </Button>
                    <p className='form-container__policy'>Нажимая на данную кнопку я даю <Link
                                                        onClick={handleShow}
                                                        style ={{textDecoration:'none'}}>
                                                            согласие</Link> на<br/> обработку моих персональных данных</p>
                </div>
            </Form>
        </div>
    )
